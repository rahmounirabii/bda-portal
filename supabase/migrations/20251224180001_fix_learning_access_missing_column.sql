-- ============================================================================
-- Fix missing includes_curriculum column in user_curriculum_access
-- Date: 2024-12-24
-- ============================================================================

-- Add the includes_curriculum column if it doesn't exist
ALTER TABLE user_curriculum_access
  ADD COLUMN IF NOT EXISTS includes_curriculum BOOLEAN DEFAULT true;

-- Recreate the function with COALESCE to handle null values
