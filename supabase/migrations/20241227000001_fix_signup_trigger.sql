-- Fix the handle_new_user trigger to properly handle new signup fields
-- This fixes the 406 error during signup

-- Drop existing trigger and function
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_user();

-- Create updated function that handles new fields
