...
import {
  ...
  useValidateFile,
} from '@/entities/support/ticket.hooks';
import type { CreateMessageDTO, TicketStatus } from '@/entities/support/ticket.types';
import {
...
/**
 * SupportTicketDetail Page (Admin)
 *
 * Displays full ticket details with admin controls
 * Allows admin to respond, change status, and manage tickets
 */
...
export default function SupportTicketDetail() {
  ...
  // Update selected status when ticket loads
  ...
  const handleStatusChange = async (newStatus: TicketStatus) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Ticket status changed to ${TICKET_STATUS_LABELS[newStatus]}`,
      });
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border bg-white p-4 shadow-sm">
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
...
SupportTicketDetail.displayName = 'SupportTicketDetail';
